        ...
        <br>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 mb-5">
                    ...
                    <b>Висновок: Pезультати групи ІТ перевищують групу Економістів за результатами
пройденого тесту "Шкала оцінки потреби у досягненні"</b>
                </div>
        ...
        <div class="row col-md-10 justify-content-center">
            ...
            <br>
            <h4>Тест "Опитувальник генералізованого тривожного розладу"</h4>
            <br>
        </div>
...
<tr><td>Cереднє</td><td>{{$sumMarkIT/$countIT}}</td><td></td><td>{{$sumMarkPhysic/$countPhysic}}</td><td></td></tr>
            ...
            Гіпотези:
            <br>
            1. Група Фізиків не перевищує групу ІТ.<br>
            2. Група Фізиків перевищує групу ІТ.
            <br>
            ...
            Uкр=102 при (p<=0.05), Uкр=82 при (p<=0.01)
            <br>
            <b> Висновок: Результати групи фізиків не перевищує групу ІТ за показниками пройденого тесту "Опитувальник генерилізованого тривожного розладу"</b>
        </p>
        </div>
